...
Diese Test-Suite ergänzt das AuthProvider-Feature um gezielte Unit-Tests und dokumentiert die wichtigsten Szenarien.
...
Diese Tests bilden das Fundament für weitere Auth-bezogene Testfälle (Widget-Tests folgen in späteren Iterationen) und erhöhen die Testbarkeit des Providers nachhaltig.
