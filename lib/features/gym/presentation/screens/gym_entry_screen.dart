...
class _GymEntryScreenState extends ConsumerState<GymEntryScreen> {
  ...
  Future<void> _selectGym(String gymId) async {
    ...
    Navigator.of(
      context,
    ).pushReplacementNamed(AppRouter.gymAccess, arguments: gymId);
  }
                        ...
                        for (final gymId in myGyms)
                          Consumer(
                            builder: (context, ref, _) {
                              final gymAsync = ref.watch(
                                gymByIdProvider(gymId),
                              );
                          ...
                          child: Column(
                            ...
                            children: [
                              PremiumTextField(
                                ...
                                onChanged: (value) {
                                  ref
                                          .read(gymSearchQueryProvider.notifier)
                                          .state =
                                      value;
                                },
                              ),
                      ...
                      if (_isDropdownOpen)
                        ConstrainedBox(
                          ...
                          child: gymsAsync.when(
                            data: (_) {
                              final prefs = ref.read(sharedPreferencesProvider);
                              final lastUsedGymId = prefs.getString(
                                StorageKeys.lastUsedGymId,
                              );
                              ...
                              return ListView.separated(
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  return AnimatedContainer(
                                        duration:
                                            AuthTheme.animationDurationMedium,
